    ...
    flake.modules.homeManager.base = {
        ...
        xdg.configFile = {
            "Code/User/keybindings.json" = {
                source = config.lib.meta.mkMutableSymlink ./_config/User/keybindings.json;
            };
            "Code/User/settings.json" = {
                source = config.lib.meta.mkMutableSymlink ./_config/User/settings.json;
            };
            "Code/User/tasks.json" = {
                source = config.lib.meta.mkMutableSymlink ./_config/User/tasks.json;
            };
            "Code/User/vscode-extensions.txt" = {
                source = config.lib.meta.mkMutableSymlink ./_config/User/vscode-extensions.txt;
            };
        };
    };
}
